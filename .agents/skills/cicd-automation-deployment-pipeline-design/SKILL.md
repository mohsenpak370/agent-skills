...
- `cicd-automation-github-actions-templates` - For GitHub Actions implementation patterns and reusable workflows
- `cicd-automation-secrets-management` - For secrets handling in CI/CD pipelines
