...
Use the inline Vault setup examples above as the reference pattern.
...
Use the inline GitHub secrets examples above as the reference pattern.
...
- `cicd-automation-github-actions-templates` - For GitHub Actions integration
