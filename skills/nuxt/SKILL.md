---
name: nuxt
description: Nuxt 3 and Nuxt 4 full-stack Vue framework with SSR, auto-imports, and file-based routing. Use when working with Nuxt apps, server routes, useFetch, useAsyncData, middleware, Nitro, modules, or hybrid rendering.
metadata:
  author: Anthony Fu
  version: "2026.1.28"
...
> The skill is based on Nuxt 3.x, generated at 2026-01-28. Most guidance also applies to Nuxt 4; verify version-specific features such as server components, islands, module package ranges, and initialization templates against the project's installed Nuxt version.
